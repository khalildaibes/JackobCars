...
export default function SpecialOfferSection1({
  ...
  return (
    <div
      {...props}
      className={`${props.className} flex flex-col items-start justify-center w-[24%] md:w-full gap-4 px-10 py-[34px] sm:p-4 bg-white-a700 shadow-xs rounded-[16px]`}
    >
