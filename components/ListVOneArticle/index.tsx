...
export default function ListVOneArticle({
  ...
  return (
    <div {...props} className={`${props.className} flex flex-col w-full bg-white-a700 rounded-[16px]`}>
      ...
      <div className="flex flex-col items-start justify-center gap-1 self-stretch rounded-bl-[16px] rounded-br-[16px] border-b border-l border-r border-solid border-gray-200 px-[30px] py-4 sm:px-5">
        <Link
          href="https://www.figma.com/design/PzQUNVEIeMrv8HjdXbjYra?node-id=19-599"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <div className="flex flex-col gap-2 self-stretch border-t border-solid border-gray-200 py-1.5">
          <div className="ml-[18px] mr-6 mt-2 flex justify-between gap-5">
