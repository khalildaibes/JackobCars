  ...
  {isMenuOpen ? <X size={28} /> : <Menu size={28} />}
      ...
      >
        <Link href="/sell"  onClick={() => setIsMenuOpen(!isMenuOpen)}>
          <button className="bg-blue-500 text-white px-4 py-2 rounded-full w-full md:w-auto shadow-lg md:shadow-xl ">Cars market</button>
        </Link>
        <Link href="/findcarbyplate" onClick={() => setIsMenuOpen(!isMenuOpen)}>
          <button className="bg-blue-700 text-white px-4 py-2 rounded-full w-full md:w-auto shadow-lg md:shadow-xl">Find By Plate number</button>
        </Link>
        ...
        <Link href="/after_market" onClick={() => setIsMenuOpen(!isMenuOpen)}>
          <button className="bg-yellow-500 text-white px-4 py-2 rounded-full w-full md:w-auto shadow-lg md:shadow-xl">After Market</button>
        </Link>
