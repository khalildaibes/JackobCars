...
<button className="md:hidden text-gray-700  " 
  ...
  {isMenuOpen ? <X size={28} /> : <Menu size={28} />}
      ...
      <div
        ...
        } md:flex flex-col md:flex-row gap-4  absolute md:relative left-0 w-full md:w-auto bg-white md:bg-transparent shadow-md md:shadow-none p-4 md:w-[40%] sm:w-[40%] md:p-0 transition-all `}
      >
