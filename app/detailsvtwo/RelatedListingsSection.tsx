...
export default function RelatedListingsSection() {
  ...
  return (
    <>
      ...
      <div className="mt-[100px] flex flex-col items-center gap-[22px] self-stretch">
              ...
              <div className="flex items-center gap-[30px] md:flex-col">
                <div className="w-[24%] rounded-[16px] bg-white-a700 md:w-full">
                  ...
                  <div className="flex flex-col gap-1 rounded-bl-[16px] rounded-br-[16px] border-b border-l border-r border-solid border-gray-200 p-4">
                    <div className="mr-2 flex flex-col items-start gap-1.5 md:mr-0">
                      <Heading size="text5xl" as="p" className="text-[18px] font-medium lg:text-[15px]">
                        Mercedes-Benz, C Class
                      </Heading>
                      <Text size="textxl" as="p" className="text-[14px] font-normal leading-[14px]">
                        <>
                    ...
                    <div className="flex flex-col items-start gap-0.5 border-t border-solid border-gray-200 py-2.5">
                      <Text size="textxl" as="p" className="mt-1 text-[14px] font-normal line-through">
                        $40,000
                      </Text>
