...
const LuxuryCarMeetupPage = () => {
  ...
  const eventDetails = {
    ...
    description: "دعوة لعشاق السيارات! 📣✨ في 18/8/2025، الساعة 6:30 مساءً (18:30)، سيكون لدينا تجمع سيارات خرافي في عكا، في موقع \"Baltimore 32, Acco Darom\" بتنظيم ASD Auto Spa Detailing. استعدوا لرؤية مجموعة مذهلة من السيارات الفاخرة والسوبر كارز من مختلف الماركات العالمية! نرجو من الجميع الحفاظ على الهدوء وتجنب المشاكل مع الشرطة. سيكون هناك دي جي، مشروبات خفيفة، وأجواء رائعة للجميع. نراكم هناك!",
    features: [
