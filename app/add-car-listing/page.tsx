        ...
        <Button
          ...
          onClick={() => {
            ...
            if (currentStep === 0) {
              ...
              if (!formData.title) {
                alert(t('please_enter_title') || 'Please enter a title');
                return;
              }
              if (!formData.mileage) {
              ...
              // Validate mandatory fields in step 1 (Condition & Description)
              ...
              // Validate mandatory fields in step 2 (Price)
              ...
              // Validate mandatory fields in step 3 (Contact)
              if (!formData.name) {
