    ...
    <div className="mt-12 px-4 sm:px-6 md:px-8 lg:px-12">
      <div className="container mx-auto flex flex-col items-center gap-6">
        ...
        <div className="relative mt-6 w-full md:w-2/3 h-64 sm:h-80 md:h-[450px] rounded-xl bg-gray-300_02 overflow-hidden">
          <GoogleMap showMarker={false} className="h-full w-full rounded-xl" />
          ...
          <div className="absolute inset-0 flex flex-col justify-between p-4">
            ...
            <Button
              size="5xl"
              shape="circle"
              className="self-center rounded-full shadow-lg bg-white p-2"
            >
            ...
            <div className="flex items-center justify-center bg-white bg-opacity-70 px-2 py-1 rounded-md self-end md:self-center">
              <Heading
                as="p"
                className="text-[10px] font-medium text-light_blue-800"
              >
                Leaflet
              </Heading>
              <Text
                size="texts"
                as="p"
                className="mx-1 text-[11px] font-medium text-blue_gray-900"
              >
                | ©
              </Text>
              <Heading
              ...
              <Heading
                as="p"
                className="ml-1 text-[10px] font-medium text-blue_gray-900"
              >
                contributors
              </Heading>
            </div>
