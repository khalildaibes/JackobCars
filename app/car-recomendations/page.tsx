                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-lg font-medium">
                        {questions[currentQuestion].id === 'budget' ? 
                          `$${answers[questions[currentQuestion].id] || 25000}` :
                          answers[questions[currentQuestion].id] || 50
                        }
                      </span>
                      <input
                        type="range"
                        min={questions[currentQuestion].id === 'budget' ? 10000 : 0}
                        max={questions[currentQuestion].id === 'budget' ? 100000 : 100}
                        value={answers[questions[currentQuestion].id] || (questions[currentQuestion].id === 'budget' ? 25000 : 50)}
