...
export async function POST(request: Request) {
  try {
    ...
    const { info, form } = body; 
    const make = info.manufacturerName;
    const model = info.commercialNickname;
    const year = info.yearOfProduction;
    console.log(make, model, year, form);
