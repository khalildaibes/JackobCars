...
export async function GET(req) {
    try {
        ...
        let apiUrl = `http://64.227.112.249/api/articles?&populate[blocks][populate]=*&populate[cover][populate]=*&populate[categories][populate]=*&populate[comments][populate]=*&populate[vedio][populate]=*`//&locale=${locale};
